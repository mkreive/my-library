                        ...
                        <div className='row'>
                            ...
                            <div className='col-md-3 mb-3'>
                                ...
                                <ul id='addNewBookId' className='dropdown-menu' aria-labelledby='dropdownMenuButton1'>
                                    <li>
                                        <a onClick={() => categoryField('Fantasy')} className='dropdown-item'>
                                            Fantasy
                                        </a>
                                    </li>
                                    <li>
                                        <a onClick={() => categoryField('Thriller')} className='dropdown-item'>
                                            Thriller
                                        </a>
                                    </li>
                                    <li>
                                        <a onClick={() => categoryField('Drama')} className='dropdown-item'>
                                            Drama
                                        </a>
                                    </li>
                                    <li>
                                        <a onClick={() => categoryField('Biography')} className='dropdown-item'>
                                            Biography
                                        </a>
                                    </li>
                                    <li>
                                        <a onClick={() => categoryField('Humor')} className='dropdown-item'>
                                            Humor
                                        </a>
                                    </li>
                                    <li>
                                        <a onClick={() => categoryField('Romance')} className='dropdown-item'>
                                            Romance
                                        </a>
                                    </li>
                                </ul>
