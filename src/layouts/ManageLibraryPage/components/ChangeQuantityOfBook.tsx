            ...
            <div className='row g-0'>
                <div className='col-md-2'>
                    <div className='d-none d-lg-block'>
                        {props.book.img ? (
                            <img src={`data:image/jpeg;base64,${props.book.img}`} width='123' height='196' alt='Book' />
                        ) : (
                            <img
                ...
                <button className='m-1 btn btn-md btn-secondary text-white' onClick={decreaseQuantity}>
                    Decrease Quantity
                </button>
            </div>
        </div>
